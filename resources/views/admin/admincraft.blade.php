...
@section('container')
    ...
    <div class="content-wrapper">
        ...
        <!-- Users -->
        <div class="col-md-12 col-xs-12" style="margin-top: -30px;overflow: auto;height: 390px;">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">All Crafts</h3>
                </div>
                <div class="box-body no-padding">
                    <ul class="users-list clearfix">
                        @foreach($craftwork as $craft)
                            <li>
                               
                                <h4 class="text-danger">Name: <span class="text-info">{{$craft->name}}</span></h4>
                                <h4 class="text-danger">Category: <span class="text-info">{{$craft->group_name}}</span></h4>
                                <h4 class="text-danger">Owner: <span class="text-info">{{$craft->craftsman_name}}</span></h4>
                                <h4 class="text-danger">Add At: <span class="text-info">{{$craft->created_at}}</span></h4>
                                <th>
                                    <button href="#" class="btn btn-info" ><span class="fa fa-comment-o"> Contact Owner</span></button>
                                    <form action="{{$craft->id}}/craftdestroy" method="post" style="display: inline;">
                                        {{csrf_field()}}
                                        {{method_field('delete')}}
