                    ...
                    <ul class="users-list clearfix">
                        @foreach($userwork as $user)
                            <li>
                                ...
                                @endforeach
                                <hr>
                                <h4 class="text-danger">Name: <span class="text-info">{{$user->name}}</span></h4>
                                <h4 class="text-danger">Username: <span class="text-info">{{$user->username}}</span></h4>
                                <h4 class="text-danger">Email: <span class="text-info">{{$user->email}}</span></h4>
                                <h4 class="text-danger">Address: <span class="text-info">{{$user->address}}</span></h4>
                                <h4 class="text-danger">Phone: <span class="text-info">{{$user->phone}}</span></h4>
                                <h4 class="text-danger">Birthdate: <span class="text-info">{{$user->birthdate}}</span></h4>
                                 <h4 class="text-danger">Purpose: <span class="text-info">{{$user->purpose}}</span></h4>

                                <h4 class="text-danger">Since: <span class="text-info">{{$user->created_at}}</span></h4>
                                <th>
                                <form action="{{route('chat',$user->id)}}" method="get" style="display: inline;">
                                        {{csrf_field()}}
                                    <button type="submit"  class="btn btn-info" ><span class="fa fa-comment-o"> Contact</span></button>
                                    </form>
                                    <form action="{{$user->id}}/userdestroy" method="post" style="display: inline;">
                                        {{csrf_field()}}
                                        {{method_field('delete')}}
